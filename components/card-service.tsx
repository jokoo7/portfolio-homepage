  ...
  return (
    <div className="relative p-4 dark:border-neutral-700 md:p-6">
      ...
      <div className="w-full">
        <span className="right-3 top-3 mb-1 flex w-max items-center justify-center rounded-lg border border-neutral-200 bg-neutral-200 bg-opacity-40 px-2 text-xs text-neutral-500 dark:border-foreground  dark:bg-secondary dark:text-teal-200 md:absolute">
          {label}
        </span>
